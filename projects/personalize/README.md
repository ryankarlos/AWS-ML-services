...
two trace ids with the following groups of segments:
...
request, and one for the work done by the function. The function segment comes with subsegments for Initialization phase (Lambda execution environment is initialised), 
